...
# Main execution
def predict_stock_prices(data_path, target_column='Close', forecast_days=30):
...
if __name__ == "__main__":
    results = predict_stock_prices('/home/augusto-mp/ENSTA/BigData/Projet-BigData/raw_stock_data/META.json')
